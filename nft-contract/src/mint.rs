...
impl Contract {
    ...
    pub fn art_mint(
        ...
        authenticat,or: AuthenticatorID,
        num_shares: u64,
        minter_id: AccountId,
    ...
    //     pub num_of_shares: u64, // number of shares that have been issued
        ...
        for i in 1..num_shares {
            ...
            let curr_token_id = art_id + i.to_string();
            ...
            // insert metadata into token metadata map
            self.token_metadata_by_id(&curr_token_id, sample_token_metadata());
